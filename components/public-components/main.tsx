...
// --- MOCK DATA ---
const GAMES = ['MODERN WARFARE II', 'COUNTER-STRIKE 2', 'VALORANT'];

const EVENTS = [
  { id: 1, title: "Dark Fall", game: "Avecar", date: "26 OCT 18:00", prize: "5000 TK", status: "LIVE", image: "https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/mw2/meta/mw2-season-03-reveal-meta.jpg" },
...
const RANKINGS = {
  ...
  'VALORANT': [
    { rank: 1, name: "Jett_Instalock", score: 1500, trend: 'up' as const },
    { rank: 2, name: "Sage_Wall", score: 1480, trend: 'up' as const },
    { rank: 3, name: "Omen_TP", score: 1420, trend: 'down' as const },
  ]
};
...
export default function HomePage() {
  const [activeRankingTab, setActiveRankingTab] = useState<keyof typeof RANKINGS>('MODERN WARFARE II');
  ...
  return (
    <div className="min-h-screen bg-bullet-dark font-mono text-bullet-text pb-20">
      ...
      <section className="relative h-[60vh] flex items-center border-b border-white/10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/mw2/meta/mw2-season-03-reveal-meta.jpg')] bg-cover bg-center opacity-40 grayscale mix-blend-overlay"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-bullet-dark via-bullet-dark/80 to-transparent"></div>
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 w-full flex flex-col justify-center h-full">
           ...
           <p className="max-w-xl text-bullet-muted text-sm md:text-base leading-relaxed mb-8 border-l-2 border-bullet-accent pl-4">
             ...
             join elite tournaments, and dominate the leaderboard.
           ...
           <div className="flex flex-wrap gap-4">
             ...
             <SecondaryButton onClick={() => console.log('Tour')}>
               System Tour
             </SecondaryButton>
           </div>
        </div>
      ...
      <div className="border-b border-white/10 bg-black/40 backdrop-blur-sm">
         <div className="max-w-[1600px] mx-auto px-8 py-4 flex flex-wrap justify-between items-center gap-8 text-xs uppercase tracking-widest text-bullet-muted">
            <div className="flex items-center gap-2">
               <span className="text-bullet-accent font-bold">14,205</span> Operators Online
            </div>
            <div className="hidden md:block w-[1px] h-4 bg-white/10"></div>
            <div className="flex items-center gap-2">
               <span className="text-white font-bold">842</span> Active Matches
            </div>
            <div className="hidden md:block w-[1px] h-4 bg-white/10"></div>
            <div className="flex items-center gap-2">
               <span className="text-white font-bold">$45,000</span> Total Prize Pool
            </div>
          ...
          <div className="relative h-96 w-full border border-bullet-accent/50 group cursor-pointer overflow-hidden">
             ...
             <div className="absolute bottom-0 left-0 p-8 w-full">
                ...
                <h3 className="text-4xl font-black text-white uppercase italic mb-2">
                  Valorant: Protocol Seven
                </h3>
                <p className="text-bullet-muted max-w-lg mb-6 text-sm">
                  Join the elite. 5v5 Tactical Shooter Tournament. 
                  Registration closes in 24 hours. Verify your squad now.
                </p>
                <PrimaryButton>Register Squad</PrimaryButton>
             </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-8 relative h-32 border border-white/10 bg-black/40 flex items-center justify-center overflow-hidden group cursor-pointer">
               ...
               <div className="text-center z-10">
                 ...
                 <div className="text-white font-bold">UPGRADE TO PRO</div>
               </div>
